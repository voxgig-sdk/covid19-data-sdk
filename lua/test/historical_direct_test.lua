...
describe("HistoricalDirect", function()
  it("should direct-load-historical", function()
    local setup = historical_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-historical", setup.live and "live" or "unit")
...
function historical_direct_setup(mockres)
