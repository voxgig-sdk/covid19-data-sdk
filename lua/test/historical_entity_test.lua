...
describe("HistoricalEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set COVID__DATA_TEST_HISTORICAL_ENTID JSON to run live")
      return
    end
...
function historical_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("COVID__DATA_TEST_HISTORICAL_ENTID")
