...
describe("AllDirect", function()
  it("should direct-load-all", function()
    local setup = all_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-all", setup.live and "live" or "unit")
...
function all_direct_setup(mockres)
