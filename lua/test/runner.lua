...
function runner.env_override(m)
  local live = runner.getenv("COVID19DATA_TEST_LIVE")
  local override = runner.getenv("COVID19DATA_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("COVID19DATA_TEST_EXPLAIN")
