...
local Covid19DataSDK = {}
Covid19DataSDK.__index = Covid19DataSDK
...
Covid19DataSDK._make_feature = _make_feature


function Covid19DataSDK.new(options)
  local self = setmetatable({}, Covid19DataSDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function Covid19DataSDK:options_map()
...
function Covid19DataSDK:get_utility()
  return Utility.copy(self._utility)
end


function Covid19DataSDK:get_root_ctx()
  return self._rootctx
end


function Covid19DataSDK:prepare(fetchargs)
...
function Covid19DataSDK:direct(fetchargs)
...
-- by passing it.
function Covid19DataSDK:_raw_request(fetchargs)
  local utility = self._utility
...
function Covid19DataSDK:graphql(query, variables, ctrl)
  ...
  if type(errors) == "table" and 0 < #errors then
    ...
    res.ok = false
    res.err = "Covid19DataSDK: graphql: " .. msg
    res.graphql = errors
  end
...
function Covid19DataSDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
  ...
  local sdk = Covid19DataSDK.new(sdkopts)
  sdk.mode = "test"
