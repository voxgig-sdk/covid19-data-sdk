...
GitHub release tag (`lua/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/covid19-data-sdk/releases)),
...
```lua
local historical, err = client:Historical():load({ id = "historical_id" })
```
