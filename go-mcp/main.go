// Command Covid19Data-mcp is an MCP server exposing the Covid19Data
// SDK as MCP tools.
//
// Two tools are registered:
//
//	Covid19Data_list  — list records of an entity
//	Covid19Data_load  — load a single record of an entity
//
