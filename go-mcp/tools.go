...
type Args struct {
	Entity string         `json:"entity" jsonschema:"all | historical"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.Covid19DataSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "covid19-data_list",
		Description: "List records from Covid19Data. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "covid19-data_load",
		Description: "Load a single record from Covid19Data. " +
...
func runOp(client *sdk.Covid19DataSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.Covid19DataSDK, name string) (sdk.Covid19DataEntity, error) {
