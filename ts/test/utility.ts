...
function envOverride(m: Record<string, any>) {
  if (
    'TRUE' === process.env.COVID19DATA_TEST_LIVE ||
    'TRUE' === process.env.COVID19DATA_TEST_OVERRIDE
  ) {
  ...
  m.COVID19DATA_TEST_EXPLAIN = process.env.COVID19DATA_TEST_EXPLAIN || m.COVID19DATA_TEST_EXPLAIN
