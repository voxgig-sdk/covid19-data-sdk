...
(0, node_test_1.describe)('AllDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-all', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-all', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['COVID19_DATA_TEST_ALL_ENTID'];
...
//# sourceMappingURL=AllDirect.test.js.map