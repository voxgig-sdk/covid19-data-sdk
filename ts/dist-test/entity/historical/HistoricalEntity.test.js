...
(0, node_test_1.describe)('HistoricalEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        (0, node_assert_1.default)(historical_ref01_data_dt0.id === historical_ref01_data.id);
    });
});
