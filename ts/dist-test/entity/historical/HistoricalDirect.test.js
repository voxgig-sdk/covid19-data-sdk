...
(0, node_test_1.describe)('HistoricalDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.Covid19DataSDK({
    ...
    (0, node_test_1.test)('direct-load-historical', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-historical', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.COVID19_DATA_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.Covid19DataSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['COVID19_DATA_TEST_HISTORICAL_ENTID'];
    ...
    const client = new __1.Covid19DataSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=HistoricalDirect.test.js.map