...
function envOverride(m) {
    if ('TRUE' === process.env.COVID19_DATA_TEST_LIVE ||
        'TRUE' === process.env.COVID19_DATA_TEST_OVERRIDE) {
    ...
    m.COVID19_DATA_TEST_EXPLAIN = process.env.COVID19_DATA_TEST_EXPLAIN || m.COVID19_DATA_TEST_EXPLAIN;
    return m;
}
