...
(0, node_test_1.describe)('exists', async () => {
    ...
    //
    // Covid19DataSDK.test() is synchronous — it returns the client, not a promise
    ...
    (0, node_test_1.test)('test-mode', () => {
        ...
        (0, node_assert_1.equal)(testsdk instanceof __1.Covid19DataSDK, true, 'Covid19DataSDK.test() must return a client synchronously');
    });
});
