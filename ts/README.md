# Covid19Data TypeScript SDK



The TypeScript SDK for the Covid19Data API — a type-safe, entity-oriented client with full async/await support.

The API is exposed as capitalised, semantic **Entities** — e.g.
`client.All()` — each with a small set of operations (`load`)
...
| `tester(testopts?, sdkopts?)` | `Covid19DataSDK` | Create a test-mode client instance. |

#### Static methods

| Method | Returns | Description |
| --- | --- | --- |
| `Covid19DataSDK.test(testopts?, sdkopts?)` | `Covid19DataSDK` | Create a test-mode client. |
...
| `client` | `client(): Covid19DataSDK` | Return the parent SDK client. |
...
covid19-data/
├── src/
│   ├── Covid19DataSDK.ts        # Main SDK class
