...
class AllEntity
  ...
  # Load a single All.
  #
  # @param reqmatch [AllLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.All.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [All, Hash] the loaded All; raises Covid19DataError on failure
