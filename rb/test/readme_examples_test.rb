...
#      offline in seeded test mode (Covid19DataSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "Covid19Data_sdk.rb")
  SDK_CLASS = "Covid19DataSDK"
