...
The PHP SDK for the Covid19Data API — an entity-oriented client using PHP conventions.
...
```
php/
├── covid19data_sdk.php          -- Main SDK class
...
The main class (`covid19data_sdk.php`) exports the SDK class
