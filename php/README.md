...
The PHP SDK for the Covid19Data API. Provides an entity-oriented interface using PHP conventions.
...
```php
[$result, $err] = $client->All(null)->load(["id" => "example_id"], null);
...
[$result, $err] = $client->Covid19Data(null)->load(
    ["id" => "test01"], null
);
