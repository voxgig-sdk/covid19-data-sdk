...
// Covid19Data SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (Covid19DataSDK::test)
...
{
    private const SDK_CLASS = 'Covid19DataSDK';
    ...
    private const SDK_BASE = 'covid19data_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../covid19data_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
