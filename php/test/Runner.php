...
class Covid19DataTestRunner
{
    ...
    {
        $live = self::getenv('COVID19_DATA_TEST_LIVE');
        $override = self::getenv('COVID19_DATA_TEST_OVERRIDE');
        ...
        $explain = self::getenv('COVID19_DATA_TEST_EXPLAIN');
...
class_alias('Covid19DataTestRunner', 'Runner');
class_alias('Covid19DataHelpers', 'Helpers');
