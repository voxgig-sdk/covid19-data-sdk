...
{
    private static function utility(): Covid19DataUtility
    {
        return new Covid19DataUtility();
    }
    ...
    private static function ctx(array $over = []): Covid19DataContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new Covid19DataContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new Covid19DataOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof Covid19DataError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new Covid19DataOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = Covid19DataMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new Covid19DataOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = Covid19DataMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new Covid19DataOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = Covid19DataMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new Covid19DataSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = Covid19DataMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new Covid19DataResponse([]),
            'result' => new Covid19DataResult([]),
        ]);
        [, $err] = Covid19DataMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new Covid19DataSpec([]),
            'response' => null,
            'result' => new Covid19DataResult([]),
        ]);
        [, $err] = Covid19DataMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new Covid19DataSpec(['step' => 's']),
            'response' => new Covid19DataResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new Covid19DataResult([]),
        ]);
        [, $err] = Covid19DataMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new Covid19DataSpec(['step' => 's']),
            'response' => new Covid19DataResponse(self::resp(200, ['v' => 1])),
            'result' => new Covid19DataResult([]),
        ]);
        [, $err] = Covid19DataMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new Covid19DataSpec(['step' => 's']),
            'response' => new Covid19DataResponse(self::resp(200, ['v' => 2])),
            'result' => new Covid19DataResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        Covid19DataMakeResponse::call($ctx);
    ...
    {
        $preset = new Covid19DataResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new Covid19DataSpec([]),
            'response' => new Covid19DataResponse([]),
            'result' => new Covid19DataResult([]),
        ...
        [$got, $err] = Covid19DataMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new Covid19DataResult([])]);
        [, $err] = Covid19DataMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new Covid19DataSpec([]), 'result' => null]);
        [, $err] = Covid19DataMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new Covid19DataSpec(['step' => 's']),
            'result' => new Covid19DataResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new Covid19DataOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = Covid19DataMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new Covid19DataSpec(['step' => 's']),
            'result' => new Covid19DataResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new Covid19DataOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = Covid19DataMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new Covid19DataResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new Covid19DataSpec([]),
            'result' => new Covid19DataResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = Covid19DataMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = Covid19DataMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new Covid19DataError('boom', 'boom');
        $utility->fetcher = function (Covid19DataContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new Covid19DataSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = Covid19DataMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (Covid19DataContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = Covid19DataMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(Covid19DataResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        Covid19DataMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (Covid19DataContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new Covid19DataSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = Covid19DataMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new Covid19DataResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new Covid19DataSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = Covid19DataMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = Covid19DataMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = Covid19DataMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new Covid19DataResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, Covid19DataDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new Covid19DataResult(['ok' => false])]);
        $this->expectException(Covid19DataError::class);
        Covid19DataDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new Covid19DataResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', Covid19DataMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        Covid19DataMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new Covid19DataBaseFeature();
        $b = new Covid19DataBaseFeature();
        Covid19DataFeatureAdd::call($ctx, $a);
        Covid19DataFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): Covid19DataBaseFeature
    {
        $f = new Covid19DataBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        Covid19DataFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): Covid19DataContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new Covid19DataSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = Covid19DataPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        Covid19DataPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new Covid19DataResponse(['headers' => null]),
            'result' => new Covid19DataResult([]),
        ]);
        Covid19DataResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        Covid19DataResultBody::call($ctx);
