...
// Covid19Data SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = Covid19DataOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(Covid19DataOmni::structfix($now, Struct::undef()))
                        !== json_encode(Covid19DataOmni::structfix($val, Struct::undef()))) {
