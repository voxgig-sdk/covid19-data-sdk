...
class AllDirectTest extends TestCase
{
    public function test_direct_load_all(): void
    {
        $setup = all_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-all", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
