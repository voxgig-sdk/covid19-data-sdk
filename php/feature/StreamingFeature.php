...
// Covid19Data SDK streaming feature
...
class Covid19DataStreamingFeature extends Covid19DataBaseFeature
{
    ...
    private function _iterate(Covid19DataResult $result): \Generator
    {
    ...
    private function _streamable(Covid19DataContext $ctx): bool
    {
