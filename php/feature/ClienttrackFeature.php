...
// Covid19Data SDK clienttrack feature
...
class Covid19DataClienttrackFeature extends Covid19DataBaseFeature
{
    ...
    public function PostConstruct(Covid19DataContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Covid19Data-SDK';
