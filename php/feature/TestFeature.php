...
// Covid19Data SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class Covid19DataTestFeature extends Covid19DataBaseFeature
{
    ...
    public function init(Covid19DataContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (Covid19DataContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = Covid19DataParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (Covid19DataContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(Covid19DataContext $ctx, $op, $args): array
    {
