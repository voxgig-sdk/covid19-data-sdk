...
class Covid19DataProxyFeature extends Covid19DataBaseFeature
{
    ...
    public function init(Covid19DataContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (Covid19DataContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
