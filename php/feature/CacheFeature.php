...
class Covid19DataCacheFeature extends Covid19DataBaseFeature
{
    ...
    private function _through(Covid19DataContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
