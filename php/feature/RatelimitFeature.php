...
// Covid19Data SDK ratelimit feature
...
class Covid19DataRatelimitFeature extends Covid19DataBaseFeature
{
    ...
    private function _acquire(Covid19DataContext $ctx): void
    {
    ...
    private function _track(Covid19DataContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
