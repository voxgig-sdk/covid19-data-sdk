...
// Covid19Data SDK netsim feature
...
class Covid19DataNetsimFeature extends Covid19DataBaseFeature
{
    ...
    private function _simulate(Covid19DataContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(Covid19DataContext $ctx, array $applied): void
    {
        $client = $this->client;
