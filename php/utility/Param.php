...
// Covid19Data SDK utility: param

require_once __DIR__ . '/../core/Helpers.php';

class Covid19DataParam
{
    public static function call(Covid19DataContext $ctx, mixed $paramdef): mixed
    {
        $point = $ctx->point;
        $spec = $ctx->spec;
        $match_val = $ctx->match;
        ...
        $akey = '';
        if ($point) {
            $alias_map = Covid19DataHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'alias'));
            if ($alias_map) {
