...
// Covid19Data SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class Covid19DataTransformResponse
{
    public static function call(Covid19DataContext $ctx): mixed
    {
        ...
        $transform = Covid19DataHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
