...
// Covid19Data SDK utility: graphql
//
...
class Covid19DataGraphql
{
    ...
    // equivalent.
    public static function body(Covid19DataContext $ctx): mixed
    {
    ...
    public static function errors(Covid19DataContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
