# Covid19Data Golang SDK Reference

Complete API reference for the Covid19Data Golang SDK.
...
#### `TestSDK(testopts, sdkopts map[string]any) *Covid19DataSDK`
...
#### `All(data map[string]any) Covid19DataEntity`

Create a new `All` entity instance. Pass `nil` for no initial data.

#### `Historical(data map[string]any) Covid19DataEntity`
