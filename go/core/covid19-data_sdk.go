...
func (sdk *Covid19DataSDK) OptionsMap() map[string]any {
...
func (sdk *Covid19DataSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *Covid19DataSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *Covid19DataSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *Covid19DataSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *Covid19DataSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath(sdk.options, []any{"allow", "op"}).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *Covid19DataSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath(sdk.options, []any{"allow", "op"}).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("Covid19DataSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *Covid19DataSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *Covid19DataSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("Covid19DataSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
