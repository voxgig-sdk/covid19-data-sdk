...
func NewHistoricalEntity(client *core.Covid19DataSDK, entopts map[string]any) *HistoricalEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *HistoricalEntity) GetName() string { return e.name }
...
func (e *HistoricalEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *HistoricalEntity) Deleted() bool {
	return e.deleted
}


func (e *HistoricalEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewHistoricalEntity(e.client, opts)
}

func (e *HistoricalEntity) Data(args ...any) any {
...
func (e *HistoricalEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Historical; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *HistoricalEntity) DataTyped(data ...Historical) Historical {
	if len(data) > 0 {
		return typedFrom[Historical](e.Data(asMap(data[0])))
	}
	return typedFrom[Historical](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Historical (all fields
// optional at the wire level).
func (e *HistoricalEntity) MatchTyped(match ...Historical) Historical {
	if len(match) > 0 {
		return typedFrom[Historical](e.Match(asMap(match[0])))
	}
	return typedFrom[Historical](e.Match())
}
...
func (e *HistoricalEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *HistoricalEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// HistoricalLoadMatch and returns an Historical. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *HistoricalEntity) LoadTyped(reqmatch HistoricalLoadMatch, ctrl map[string]any) (Historical, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Historical{}, err
	}
	return typedFrom[Historical](res), nil
}



func (e *HistoricalEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *HistoricalEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *HistoricalEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *HistoricalEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *HistoricalEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
