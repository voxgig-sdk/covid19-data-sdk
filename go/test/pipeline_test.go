...
func plClient(t *testing.T, sdkopts map[string]any) (*sdk.Covid19DataSDK, *sdk.Utility) {
	t.Helper()
	client := sdk.TestSDK(nil, sdkopts)
	return client, client.GetUtility()
}

func plCtx(client *sdk.Covid19DataSDK, utility *sdk.Utility, ctrl map[string]any) *sdk.Context {
