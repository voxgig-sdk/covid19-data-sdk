...
const testSeed = `map[string]any{"entity": map[string]any{"all": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "historical": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
