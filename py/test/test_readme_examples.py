# Covid19Data SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions Covid19DataSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both Covid19DataSDK(...) and Covid19DataSDK.test(...) become
#      Covid19DataSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "covid19data_sdk"
_SDK_CLASS = "Covid19DataSDK"
