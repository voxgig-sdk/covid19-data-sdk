...
from covid19data_sdk.core.helpers import get_ctx_prop, to_map
...
class Covid19DataContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(sp, Covid19DataSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, Covid19DataResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, Covid19DataResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return Covid19DataError(code, msg, self)
