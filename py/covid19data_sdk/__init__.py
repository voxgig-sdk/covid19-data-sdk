...
from covid19data_sdk.utility import register

# Load features
from covid19data_sdk.feature.base_feature import Covid19DataBaseFeature
from covid19data_sdk.features import _has_feature, _make_feature
...
class Covid19DataSDK:
    ...
    def get_utility(self):
        return Covid19DataUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("Covid19DataSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def All(self, data=None) -> "AllEntity":
        ...
        from covid19data_sdk.entity.all_entity import AllEntity
    ...
    def Historical(self, data=None) -> "HistoricalEntity":
        ...
        from covid19data_sdk.entity.historical_entity import HistoricalEntity
