...
class Covid19DataRbacFeature extends Covid19DataBaseFeature
{
    ...
    private function _required(Covid19DataContext $ctx): ?string
    {
    ...
    private function _reject(Covid19DataContext $ctx, string $required): void
    {
    ...
    private function _track(Covid19DataContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
