...
// Covid19Data SDK timeout feature
...
class Covid19DataTimeoutFeature extends Covid19DataBaseFeature
{
    ...
    private function _with_timeout(Covid19DataContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(Covid19DataContext $_ctx, float $ms): void
    {
        $client = $this->client;
