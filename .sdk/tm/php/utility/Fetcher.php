...
// Covid19Data SDK utility: fetcher

class Covid19DataFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; Covid19DataSDK/1.0)';
    ...
    public static function call(Covid19DataContext $ctx, string $fullurl, array $fetchdef): array
    {
