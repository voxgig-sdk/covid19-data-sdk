...
class Covid19DataTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = Covid19DataTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = Covid19DataTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = Covid19DataTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
