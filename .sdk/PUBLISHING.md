...
|---|---|---|
| `ts/` | @voxgig-sdk/covid19-data-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/covid19-data-sdk \
      --repository voxgig-sdk/covid19-data-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/covid19-data-sdk` shows it, and
`npm trust revoke @voxgig-sdk/covid19-data-sdk --id=<id>` removes it.
