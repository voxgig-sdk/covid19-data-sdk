...
func registerSDKWords(r *eng.Registry, client *sdk.Covid19DataSDK) {
...
func runOp(client *sdk.Covid19DataSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
