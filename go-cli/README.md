...
AQL-driven CLI and REPL for the Covid19Data SDK. Positional arguments are
...
./covid19-data-cli list all
./covid19-data-cli load 1 all
./covid19-data-cli load '{id:1}' all
