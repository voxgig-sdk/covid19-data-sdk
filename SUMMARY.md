...
Results: Successful response with historical COVID-19 data.
...
Results: Successful response with country historical data.
...
| --- | --- | --- | --- |
| All | `load` | `GET /historical/all` | See reference |
| Historical | `load` | `GET /historical/{country}` | See reference |

## Connect to the API

- Production server: `https://disease.sh/v3/covid-19`
...
- `covid19-data_list`: List records for an entity. No active entity supports this operation.
- `covid19-data_load`: Load one record for an entity. Supported entities: `all`, `historical`.
